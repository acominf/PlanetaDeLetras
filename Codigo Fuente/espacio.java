...
public class espacio extends World
{
     ...
     */
    public espacio(int vidas,int score)
    {    
        ...
        addObject(avion,250,getHeight()-60);
    ...
    public void addEnemigo()
    {
     ...
     addObject(e,x,0);
     addObject(e2,x+150,0);
     addObject(e3,x-150,0);
    }
    ...
    public void addLiderEnemigo(int x){
        ...
        LiderEnemigo liderEnemigo2 = new LiderEnemigo();
        addObject(liderEnemigo ,x, 55);
        addObject(liderEnemigo2 ,700, 55);
    }
